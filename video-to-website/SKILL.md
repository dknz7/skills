...
description: Create scroll-driven, video-hero landing pages and marketing sites with GSAP animations, editorial typography, and cinematic layouts. Use when the user wants a landing page, marketing site, or any page featuring video backgrounds, scroll-pinning, animated stats, or marquee text.
